...
namespace SOI_Api.Models
{
    public class Delegation
    {
        ...
        public Delegation(apiSearchAthleteByEvent_Result dbAthlete)
        {
    ...
    public class Division
    {
        ...
        public Division(apiSearchAthleteByEvent_Result dbAthlete)
        {
            name = dbAthlete.dvsn_name;
            round = dbAthlete.dvsn_round.ToString();
            if (dbAthlete.IsTeamEvent.GetValueOrDefault())
        ...
        public void Add(apiSearchAthleteByEvent_Result dbAthlete)
        {
            if (dbAthlete.IsTeamEvent.GetValueOrDefault())
            {
                if ((teams.Count > 0) && (teams[teams.Count - 1].guid == dbAthlete.team_guid))
                {
    ...
    public class EventByGameIdRootObject
    {
        ...
        {
            if ((sports.Count > 0) && (sports[sports.Count - 1].guid == dbSportingEvent.sprt_guid))
            {
    ...
    public class Name
    {
        ...
        public Name(apiSearchAthleteByEvent_Result dbAthlete)
        {
    ...
    public class Result
    {
        ...
        public Result(apiSearchAthleteByID_Result dbAthlete)
        {
            ...
            matchid = dbAthlete.rslt_matchid.GetValueOrDefault().ToString();
    ...
    public class Event
    {
        ...
        public Event(apiSearchAthleteByEvent_Result dbAthlete)
        {
        ...
        public void Add(apiSearchAthleteByEvent_Result dbAthlete)
        {
            if ((division.Count > 0) && (division[division.Count - 1].name == dbAthlete.dvsn_name))
            {
    ...
    public class Sport
    {
        ...
        {
            guid = dbSportingEvent.sprt_guid;
    ...
    public class Athlete
    {
        ...
        public Athlete(apiSearchAthleteByEvent_Result dbAthlete)
        {
    ...
    public class Team
    {
        ...
        public Team(apiSearchAthleteByEvent_Result dbAthlete)
        {
